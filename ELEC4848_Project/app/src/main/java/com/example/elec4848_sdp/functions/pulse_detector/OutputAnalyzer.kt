package com.example.elec4848_sdp.functions.pulse_detector
...
internal class OutputAnalyzer(
    private val activity: PulseDetector,
            ...
            override fun onFinish() {
                ...
                if (valleys.size == 0) {
                    mainHandler.sendMessage(
                        Message.obtain(
                            mainHandler,
                            PulseDetector.MESSAGE_CAMERA_NOT_AVAILABLE,
                ...
                sendMessage(PulseDetector.MESSAGE_UPDATE_FINAL, returnValueSb.toString())
                cameraService.stop()
            }
        }
