...
import com.example.elec4848_sdp.functions.profile.UserModel
import com.example.elec4848_sdp.functions.profile.UserSQLiteHelper
import com.example.elec4848_sdp.views.activity.MainActivity
...
class CreateProfile : AppCompatActivity() {
    ...
    private lateinit var maleSelectButton: RadioButton
    private lateinit var femaleSelectButton: RadioButton
    private var selectedGender: Int = 0

    private lateinit var exerciseHighButton: RadioButton
    private lateinit var exerciseLowButton: RadioButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        maleSelectButton = findViewById(R.id.Male)
        femaleSelectButton = findViewById(R.id.Female)
        exerciseHighButton = findViewById(R.id.High)
        exerciseLowButton = findViewById(R.id.Low)
        ...
        if (exerciseHighButton.isChecked) {
            selectedActivity = 0
        } else if (exerciseLowButton.isChecked) {
            selectedActivity = 1
        }
