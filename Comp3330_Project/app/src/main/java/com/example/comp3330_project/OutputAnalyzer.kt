...
internal class OutputAnalyzer(
    private val activity: HeartBeatMain,
    ...
    private fun detectValley(): Boolean {
        ...
        return if (subList.size < valleyDetectionWindowSize) {
            ...
            val referenceValue = subList[Math.ceil((valleyDetectionWindowSize / 2f).toDouble())
                .toInt()]!!.measurement
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                val thread = Thread {
                    ...
                    if (detectValley()) {
                        ...
                        sendMessage(HeartBeatMain.MESSAGE_UPDATE_REALTIME, currentValue)
                    }
            ...
            override fun onFinish() {
                ...
                if (valleys.size == 0) {
                    mainHandler.sendMessage(
                        Message.obtain(
                            mainHandler,
                            HeartBeatMain.MESSAGE_CAMERA_NOT_AVAILABLE,
                ...
                sendMessage(HeartBeatMain.MESSAGE_UPDATE_FINAL, returnValueSb.toString())
                cameraService.stop()
            }
        }
